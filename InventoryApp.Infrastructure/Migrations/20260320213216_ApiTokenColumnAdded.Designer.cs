...
namespace InventoryApp.Infrastructure.Migrations
{
    ...
    [Migration("20260320213216_ApiTokenColumnAdded")]
    partial class ApiTokenColumnAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InventoryApp.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 20, 21, 32, 15, 404, DateTimeKind.Utc).AddTicks(1755),
                            Name = "Equipment"
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2026, 3, 20, 21, 32, 15, 404, DateTimeKind.Utc).AddTicks(1765),
                            Name = "Furniture"
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2026, 3, 20, 21, 32, 15, 404, DateTimeKind.Utc).AddTicks(1767),
                            Name = "Books"
                        },
                        new
                        {
                            Id = new Guid("44444444-4444-4444-4444-444444444444"),
                            CreatedAt = new DateTime(2026, 3, 20, 21, 32, 15, 404, DateTimeKind.Utc).AddTicks(1769),
                            Name = "Other"
                        });
                });
