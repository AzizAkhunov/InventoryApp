...
namespace InventoryApp.Infrastructure.Migrations
{
    ...
    [Migration("20260311123817_AddNotifications")]
            ...
            modelBuilder.Entity("InventoryApp.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 11, 12, 38, 17, 165, DateTimeKind.Utc).AddTicks(7799),
                            Name = "Equipment"
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2026, 3, 11, 12, 38, 17, 165, DateTimeKind.Utc).AddTicks(7805),
                            Name = "Furniture"
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2026, 3, 11, 12, 38, 17, 165, DateTimeKind.Utc).AddTicks(7807),
                            Name = "Books"
                        },
                        new
                        {
                            Id = new Guid("44444444-4444-4444-4444-444444444444"),
                            CreatedAt = new DateTime(2026, 3, 11, 12, 38, 17, 165, DateTimeKind.Utc).AddTicks(7808),
                            Name = "Other"
                        });
                });
